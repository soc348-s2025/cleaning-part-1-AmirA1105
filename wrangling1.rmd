...
table_of_contents <- table_of_contents |> 
  mutate(younger = substr(text, 1, 1) == "*",
         ...
         text = sub("_page_ vii", "", text, fixed = TRUE), 
...
earlier? 
The na values should've been dropped. This could've been done during the step where the stop words and puncuation were removed.
